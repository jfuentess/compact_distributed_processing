...
for file in "/home/pi/tests/encoded_files"/*; do
    ...
    yarn jar /home/pi/VariableEncodingGlobal/VariableEncodingGlobal.jar VEG.VariableEncodingGlobal /user/pi/tests/input /user/pi/tests/dictionary /user/pi/tests/output

    # Get the output from the HDFS
    hadoop fs -get /user/pi/tests/output/output_0 /home/pi/tests/tmp/

    # Rename the output file to output_$count
    mv /home/pi/tests/tmp/output_0 /home/pi/tests/phase3_files/output_$count
...
# Remove the dictionary from the HDFS
hadoop fs -rm /user/pi/tests/dictionary
