...
// Custom OutputFormat
public class VEGOutputFormat extends FileOutputFormat<NullWritable, BytesWritable> {
    ...
    // Custom RecordWriter
    private static class VEGRecordWriter extends RecordWriter<NullWritable, BytesWritable> {
